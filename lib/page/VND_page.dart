...
class VNDPage extends StatefulWidget {
  const VNDPage({Key? key}) : super(key: key);

  @override
  State<VNDPage> createState() => _LoginPageState();
}

class _LoginPageState extends State<VNDPage> {
  var _feedbackText = '';
  ...
  void _handleclick(int i){
    ...
    switch(i){
      case 1:
        setState(() {
          _feedbackText = "${temp.toStringAsFixed(2)} บาทเท่ากับ ${MyConverter.B2VND(temp).toStringAsFixed(2)}ดงเวียดนาม";
        });
        break;
    }
  }
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text('แปลงจากสกุลเงินบาทเป็นสกุลเงินดงเวียดนาม',style: TextStyle(fontSize: 40)),
            Row(
              ...
              children: [
                ...
                SizedBox(width: 30.0),
                Image.asset('assets/images/VND.png', width: 150.0,height:120.0,fit: BoxFit.cover),
              ],
            ),
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      _buildButton("แปลงเป็นเงินดงเวียดนาม",1),
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('อัตราแลกเปลี่ยน 1 ฿ = 690.37 ดงเวียดนาม',style: TextStyle(fontSize: 30),)
                    ],
                  ),
                ],
              ),

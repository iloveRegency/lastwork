...
class _LoginPageState extends State<LaoPage> {
  ...
  void _handleclick(int i){
    ...
    switch(i){
      case 1:
        setState(() {
          _feedbackText = "$temp บาทเท่ากับ ${MyConverter.B2LAK(temp).toStringAsFixed(2)}กีบ";
        });
        break;
    }
  }
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: 30.0),
                Image.asset('assets/images/lao.png', width: 150.0,height:120.0,fit: BoxFit.cover),
              ],
            ),
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('อัตราแลกเปลี่ยน 1 ฿ = 471.22 กีบ',style: TextStyle(fontSize: 30),)
                    ],
                  ),
                ],
              ),

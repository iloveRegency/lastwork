...
class BNDPage extends StatefulWidget {
  const BNDPage({Key? key}) : super(key: key);

  @override
  State<BNDPage> createState() => _LoginPageState();
}

class _LoginPageState extends State<BNDPage> {
  var _feedbackText = '';
  ...
  void _handleclick(int i){
    ...
    switch(i){
      case 1:
        setState(() {
          _feedbackText = "${temp.toStringAsFixed(2)} บาทเท่ากับ ${MyConverter.B2BND(temp).toStringAsFixed(2)}ดอลลาร์บรูไน";
        });
        break;
    }
  }
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text('แปลงจากสกุลเงินบาทเป็นสกุลเงินดอลลาร์บรูไน',style: TextStyle(fontSize: 40)),
            Row(
              ...
              children: [
                ...
                SizedBox(width: 30.0),
                Image.asset('assets/images/BND.png', width: 150.0,height:120.0,fit: BoxFit.cover),
              ],
            ),
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      _buildButton("แปลงเป็นเงินดอลลาร์บรูไน",1),
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('อัตราแลกเปลี่ยน 1 ฿ = 0.038200 ดอลลาร์บรูไน',style: TextStyle(fontSize: 30),)
                    ],
                  ),
                ],
              ),

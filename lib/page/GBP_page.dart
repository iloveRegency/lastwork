...
class _LoginPageState extends State<GBPPage> {
  ...
  void _handleclick(int i){
    ...
    switch(i){
      case 1:
        setState(() {
          _feedbackText = "$temp บาทเท่ากับ ${MyConverter.B2GBP(temp).toStringAsFixed(2)}}ปอนด์สเตอร์ลิง";
        });
        break;
    }
  }
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: 30.0),
                Image.asset('assets/images/GBP.png', width: 150.0,height:120.0,fit: BoxFit.cover),
              ],
            ),
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('อัตราแลกเปลี่ยน 1 ฿ = 0.027 ปอนด์สเตอร์ลิง',style: TextStyle(fontSize: 30),)
                    ],
                  ),
                ],
              ),

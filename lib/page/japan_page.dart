...
class _LoginPageState extends State<JapanPage> {
  ...
  void _handleclick(int i){
    ...
    switch(i){
      case 1:
        setState(() {
          _feedbackText = "${temp.toStringAsFixed(2)} บาทเท่ากับ ${MyConverter.B2Y(temp).toStringAsFixed(2)}¥";
        });
        break;
    }
  }
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: 30.0),
                Image.asset('assets/images/japan.png', width: 150.0,height:120.0,fit: BoxFit.cover),
              ],
            ),
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('อัตราแลกเปลี่ยน 1 ฿ = 3.8589 ¥',style: TextStyle(fontSize: 30),)
                    ],
                  ),
                ],
              ),

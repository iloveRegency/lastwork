...
class _LoginPageState extends State<USDPage> {
  ...
  void _handleclick(int i){
    ...
    switch(i){
      case 1:
        setState(() {
          _feedbackText = "$temp บาทเท่ากับ ${MyConverter.B2USD(temp).toStringAsFixed(2)}ดอลลาร์สหรัฐ";
        });
        break;
    }
  }
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: 30.0),
                Image.asset('assets/images/USD.png', width: 150.0,height:120.0,fit: BoxFit.cover),
              ],
            ),
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('อัตราแลกเปลี่ยน 1 ฿ = 0.0278 ดอลลาร์สหรัฐ',style: TextStyle(fontSize: 30),)
                    ],
                  ),
                ],
              ),
